  ...
  history: [
    {
      ...
      items: [
        { id: 'lr-future-1', date: 'January 1, 2026', leaveType: 'Vacation Leave', currentBalance: -1.0, leaveAmount: 15.0, remainingBalance: 14.0, reason: 'Annual Reset (Debt Deducted)', action: 'Credit', isPaid: true },
        { id: 'lr-future-2', date: 'January 1, 2026', leaveType: 'Sick Leave', currentBalance: 15.0, leaveAmount: 15.0, remainingBalance: 15.0, reason: 'Annual Reset', action: 'Credit', isPaid: true }
      ] as HistoryItem[]
    },
    {
      group: 'Nov 2025',
      items: [
        { id: 'lr-overdraft', date: 'November 15, 2025', leaveType: 'Vacation Leave', currentBalance: 0.0, leaveAmount: 1.0, remainingBalance: -1.0, reason: 'Approved Overdraft', action: 'Debit', isPaid: false }
      ] as HistoryItem[]
    },
    {
      group: 'Aug 2025',
      items: [
        { id: 'lr-55', date: 'August 24, 2025', leaveType: 'Vacation Leave', currentBalance: 5.0, leaveAmount: 5.0, remainingBalance: 0.0, reason: 'Family Vacation', action: 'Debit', isPaid: true }
      ] as HistoryItem[]
    },
    {
      group: 'Jan 2025',
      items: [
        { id: 'lr-start', date: 'January 1, 2025', leaveType: 'Vacation Leave', currentBalance: 0.0, leaveAmount: 15.0, remainingBalance: 15.0, reason: 'Annual Reset', action: 'Credit', isPaid: true }
      ] as HistoryItem[]
    }
  ]
};
              ...
              <div className="bg-slate-50 rounded-2xl overflow-hidden border border-slate-200">
                <table className="w-full text-sm text-left table-fixed">
                  <thead className="bg-slate-500 text-white font-bold text-[10px] uppercase tracking-widest">
                    <tr>
                      <th className="px-6 py-4 w-[16%]">Date</th>
                      <th className="px-6 py-4 w-[16%]">Leave Type</th>
                      ...
                      <th className="px-6 py-4 w-[12%]">Reason</th>
                    ...
                    {group.items.map((item, i) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span className={`text-[9px] font-black uppercase tracking-tighter px-2 py-0.5 rounded-full border ${item.isPaid ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-rose-50 text-rose-600 border-rose-100'}`}>
