...
const REPORT_DEFINITIONS: Record<string, ReportDefinition> = {
  // ── 3 Master Reports (full column set) ───────────────────────────────────────
  ...
  'rep-em-03': { id: 'rep-em-03', title: 'Masterlist ALL w/out Salary',             category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Rank / Job Level', 'Employment Status', 'Employment Type', 'Date Hired', 'Work Schedule'] },
  'rep-em-04': { id: 'rep-em-04', title: 'Masterlist of Indirect Labor',            category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Employment Type', 'Date Hired', 'Work Schedule'] },
  'rep-em-05': { id: 'rep-em-05', title: 'Masterlist w/ SSS/TIN of Direct Labor',  category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'TIN', 'SSS No.', 'PhilHealth No.', 'HDMF No.'] },
  'rep-em-06': { id: 'rep-em-06', title: 'Masterlist w/ SSS/TIN of Indirect Labor',category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'TIN', 'SSS No.', 'PhilHealth No.', 'HDMF No.'] },
  'rep-em-07': { id: 'rep-em-07', title: 'Masterlist of Resigned Employees',       category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Date Hired', 'Date of Contract End'] },
  'rep-em-08': { id: 'rep-em-08', title: 'Masterlist to Excel',                    category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Rank / Job Level', 'Employment Status', 'Employment Type', 'Monthly Basic Pay', 'Date Hired'] },
  'rep-em-09': { id: 'rep-em-09', title: 'Employee General List',                  category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Company Email', 'Mobile No.'] },
  'rep-em-10': { id: 'rep-em-10', title: 'Manpower Report',                        category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Employment Type'] },
  'rep-em-11': { id: 'rep-em-11', title: 'Positions Listing',                      category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Rank / Job Level', 'Employment Status', 'Employment Type'] },
  'rep-em-12': { id: 'rep-em-12', title: 'Demographics',                           category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Tax Status', 'Employment Type'] },
  'rep-em-13': { id: 'rep-em-13', title: 'DOLE Report',                            category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Employment Type', 'Date Hired'] },
  'rep-em-14': { id: 'rep-em-14', title: 'Years of Service Report',                category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Date Hired', 'Date Regularized'] },
  'rep-em-15': { id: 'rep-em-15', title: 'Birthdates',                             category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Company Email', 'Employment Status'] },
  'rep-em-16': { id: 'rep-em-16', title: 'Masterlist All Per Division',            category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Rank / Job Level', 'Employment Status', 'Employment Type'] },
  'rep-em-17': { id: 'rep-em-17', title: 'Employee Data By Date Hired',            category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Type', 'Date Hired', 'Date Regularized'] },
  'rep-em-18': { id: 'rep-em-18', title: '201 File',                               category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Date Hired', 'TIN', 'SSS No.', 'HDMF No.'] },
  'rep-em-19': { id: 'rep-em-19', title: 'Alumni Report',                          category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Date Hired', 'Date of Contract End'] },
  'rep-em-20': { id: 'rep-em-20', title: 'PAF',                                    category: 'Employee Masterlist', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Rank / Job Level', 'Employment Status', 'Employment Type', 'Date Hired', 'Immediate Supervisor'] },

  // ── Time and Attendance Sub-Reports ───────────────────────────────────────────
  'rep-ta-late': { id: 'rep-ta-late', title: 'Late',                               category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Work Schedule', 'Late (mins)', 'Remarks'] },
  'rep-ta-ut':   { id: 'rep-ta-ut',   title: 'Undertime',                          category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Work Schedule', 'Undertime (mins)', 'Remarks'] },
  'rep-ta-ot':   { id: 'rep-ta-ot',   title: 'OT Report',                          category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Day Type', 'Overtime Hours', 'Rest Day OT Hours', 'Total Hours Worked', 'Remarks'] },
  'rep-ta-slvl': { id: 'rep-ta-slvl', title: 'SLVL Balance',                       category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'VL Balance', 'SL Balance'] },
  'rep-ta-att':  { id: 'rep-ta-att',  title: 'Attendance',                         category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Time In', 'Time Out', 'Total Hours Worked', 'Absent'] },
  'rep-ta-sumh': { id: 'rep-ta-sumh', title: 'Time and Attendance Summary Report History', category: 'Time & Attendance', type: 'Standard', sourceId: 'rep-ta-1', visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Work Schedule', 'Time In', 'Time Out', 'Total Hours Worked', 'Late (mins)'] },
  'rep-ta-dtr':  { id: 'rep-ta-dtr',  title: 'DTR',                                category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Time In', 'Time Out', 'Total Hours Worked', 'Remarks'] },
  'rep-ta-dtrh': { id: 'rep-ta-dtrh', title: 'DTR History',                        category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Time In', 'Time Out', 'Total Hours Worked', 'Remarks'] },
  'rep-ta-vlsl': { id: 'rep-ta-vlsl', title: 'VLSL Application',                   category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Leave Type', 'Leave Status', 'Remarks'] },
  'rep-ta-vlslh':{ id: 'rep-ta-vlslh',title: 'VLSL Application History',           category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Leave Type', 'Leave Status', 'Absent', 'Remarks'] },
  'rep-ta-mh':   { id: 'rep-ta-mh',   title: 'Manhour Report',                     category: 'Time & Attendance',   type: 'Standard', sourceId: 'rep-ta-1',  visibleColumns: ['Date', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Work Schedule', 'Total Hours Worked', 'Overtime Hours', 'Absent'] },

  // ── Payroll System (PAYSYS) Sub-Reports ──────────────────────────────────────
  'rep-ps-hist':        { id: 'rep-ps-hist',        title: 'Payslip History',                     category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay', 'Disbursement Status'] },
  'rep-ps-loans':       { id: 'rep-ps-loans',       title: 'Employee Loans',                      category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'SSS Contribution', 'Pag-IBIG (HDMF)', 'Total Deductions'] },
  'rep-ps-journal':     { id: 'rep-ps-journal',     title: 'Payroll Journal',                     category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Gross Earnings', 'Total Deductions', 'Net Pay', 'Payment Method'] },
  'rep-ps-jd':          { id: 'rep-ps-jd',          title: 'Payroll Journal Dailies',             category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay'] },
  'rep-ps-period':      { id: 'rep-ps-period',      title: 'Payroll Period',                      category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Net Pay'] },
  'rep-ps-13th-dept':   { id: 'rep-ps-13th-dept',   title: '13th MO Entries Dept',                category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Basic Pay', 'Gross Earnings'] },
  'rep-ps-fdtr':        { id: 'rep-ps-fdtr',        title: 'Payslip Final DTR',                   category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay', 'Disbursement Status'] },
  'rep-ps-fdtrh':       { id: 'rep-ps-fdtrh',       title: 'Payslip Final DTR History',           category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Net Pay', 'Disbursement Status'] },
  'rep-ps-13th-slip':   { id: 'rep-ps-13th-slip',   title: '13th Payslip',                        category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Net Pay'] },
  'rep-ps-13th-all':    { id: 'rep-ps-13th-all',    title: '13th Summary ALL',                    category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay'] },
  'rep-ps-entries':     { id: 'rep-ps-entries',     title: 'Payroll Entries',                     category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Rice Subsidy', 'Meal Allowance', 'Transportation Allowance', 'Gross Earnings'] },
  'rep-ps-slvl':        { id: 'rep-ps-slvl',        title: 'SLVL Summary',                        category: 'Payroll', type: 'Standard', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'VL Balance', 'SL Balance'] },
  'rep-ps-coop':        { id: 'rep-ps-coop',        title: 'Coop Contribution',                   category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Total Deductions', 'Net Pay'] },
  'rep-ps-hdmf':        { id: 'rep-ps-hdmf',        title: 'HDMF Contribution',                   category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Pag-IBIG (HDMF)', 'Net Pay'] },
  'rep-ps-hdmfh':       { id: 'rep-ps-hdmfh',       title: 'HDMF Contribution History',           category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Pag-IBIG (HDMF)', 'Total Deductions'] },
  'rep-ps-mp2':         { id: 'rep-ps-mp2',         title: 'HDMF Contribution MP2',               category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Pag-IBIG (HDMF)'] },
  'rep-ps-mp2m':        { id: 'rep-ps-mp2m',        title: 'HDMF Contribution History MP2 Month', category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Pag-IBIG (HDMF)', 'Total Deductions'] },
  'rep-ps-hdmf-loan':   { id: 'rep-ps-hdmf-loan',   title: 'HDMF Loan Report',                    category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Pag-IBIG (HDMF)', 'Total Deductions', 'Net Pay'] },
  'rep-ps-loan-hist':   { id: 'rep-ps-loan-hist',   title: 'Loan Report History',                 category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'SSS Contribution', 'Pag-IBIG (HDMF)', 'Total Deductions'] },
  'rep-ps-monthly-loans':{ id: 'rep-ps-monthly-loans', title: 'Monthly Loans Report',             category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'SSS Contribution', 'PhilHealth Premium', 'Pag-IBIG (HDMF)', 'Total Deductions'] },

  // ── Additional Payroll Reports ────────────────────────────────────────────────
  'rep-ap-monthly':   { id: 'rep-ap-monthly',   title: 'Monthly Report',               category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay'] },
  'rep-ap-sss':       { id: 'rep-ap-sss',       title: 'Monthly SSS Loans Report',     category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'SSS Contribution', 'Total Deductions'] },
  'rep-ap-last-pay':  { id: 'rep-ap-last-pay',  title: 'Last Pay',                     category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay', 'Payment Method'] },
  'rep-ap-ledger':    { id: 'rep-ap-ledger',    title: 'Payroll Ledger',               category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay'] },
  ...
  'rep-ap-acct-m':    { id: 'rep-ap-acct-m',    title: 'Accounting Details Monthly',   category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Basic Pay', 'Gross Earnings', 'Total Deductions', 'Net Pay', 'Disbursement Status'] },
  'rep-ap-acct-sm':   { id: 'rep-ap-acct-sm',   title: 'Accounting Summary Monthly',   category: 'Payroll', type: 'Standard', sourceId: 'rep-pay-1', visibleColumns: ['Pay Period', 'Employee ID', 'Last Name', 'First Name', 'Department', 'Gross Earnings', 'Total Deductions', 'Net Pay'] },

  // ── Pre-defined Custom Reports ───────────────────────────────────────────────
  'rep-cust-1': { id: 'rep-cust-1', title: 'Q1 2026 New Hire Tracker',                category: 'Employee Masterlist', type: 'Custom', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Type', 'Date Hired'] },
  ...
  'rep-cust-3': { id: 'rep-cust-3', title: 'Salary Grade Distribution',               category: 'Employee Masterlist', type: 'Custom', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Rank / Job Level', 'Monthly Basic Pay', 'Salary Grade'] },
  'rep-cust-4': { id: 'rep-cust-4', title: 'Voluntary Attrition Analysis — FY 2025', category: 'Employee Masterlist', type: 'Custom', sourceId: 'rep-hr-1',  visibleColumns: ['Employee ID', 'Last Name', 'First Name', 'Department', 'Position', 'Employment Status', 'Employment Type', 'Date Hired', 'Date Regularized'] },
