...
export const MOCK_SETUPS: ApprovalSetup[] = [
  ...
  {
    id: '14',
    name: 'HR Personnel Action Form',
    connectedEmployees: 25,
    dateAdded: 'Mar 10, 2026',
    lastModifiedBy: 'Sarah Wilson',
    lastModified: 'Mar 10, 2026 09:00',
    feature: 'PAF Request',
    autoRejectDays: 7,
    postApprovalExpiryDays: 0,
    department: 'Human Resources',
    ...
    approvers: [
      { id: 'a-hrpaf-1', orderLabel: 'Approver 1', name: 'Sarah Wilson', role: 'CHRO', avatar: 'SW', department: 'Human Resources', lastModifiedBy: 'Sarah Wilson', lastModified: 'Mar 10, 2026' },
      { id: 'a-hrpaf-2', orderLabel: 'Verifier', name: 'Marcus Reyes', role: 'CEO', avatar: 'MR', department: 'Nexus Corp', lastModifiedBy: 'Sarah Wilson', lastModified: 'Mar 10, 2026' },
    ],
  },
  {
    id: '12',
