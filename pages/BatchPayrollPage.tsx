...
const MOCK_ATTENDANCE = [
    { date: 'Aug 06, 2025', status: 'present', in: '07:55 AM', out: '05:01 PM', hours: 8.0, ot: 0 },
    { date: 'Aug 07, 2025', status: 'present', in: '08:00 AM', out: '05:05 PM', hours: 8.0, ot: 0.5 },
    { date: 'Aug 08, 2025', status: 'late', in: '09:12 AM', out: '06:12 PM', hours: 8.0, ot: 0 },
    { date: 'Aug 11, 2025', status: 'present', in: '07:58 AM', out: '05:00 PM', hours: 8.0, ot: 0 },
    { date: 'Aug 12, 2025', status: 'absent', in: '-', out: '-', hours: 0, ot: 0 },
    { date: 'Aug 13, 2025', status: 'overtime', in: '08:00 AM', out: '08:30 PM', hours: 11.5, ot: 3.5 },
    { date: 'Aug 14, 2025', status: 'present', in: '07:45 AM', out: '05:00 PM', hours: 8.0, ot: 0 },
    { date: 'Aug 15, 2025', status: 'leave', in: '-', out: '-', hours: 0, ot: 0 },
    { date: 'Aug 18, 2025', status: 'present', in: '08:00 AM', out: '05:00 PM', hours: 8.0, ot: 0 },
    { date: 'Aug 19, 2025', status: 'present', in: '07:55 AM', out: '05:05 PM', hours: 8.0, ot: 0 },
    { date: 'Aug 20, 2025', status: 'present', in: '08:05 AM', out: '05:00 PM', hours: 8.0, ot: 0 },
];
                        ...
                        {employeesQueue.map((emp, idx) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all border ${isActive ? 'bg-indigo-50 border-indigo-200 shadow-sm' : 'bg-white border-transparent hover:bg-slate-50'
                                        }`}
                                >
                ...
                <div className="flex-1 bg-slate-50 p-8 overflow-y-auto flex flex-col items-center">
                    {activeEmployee ? (
                        <div className="w-full max-w-5xl space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                            ...
                            {/* Unified Payslip Artifact View */}
                            <div className="flex flex-col items-center sticky top-0">
                                <div className="w-full max-w-4xl space-y-6">
                                    <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl shadow-slate-200/50 flex justify-center">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <button className="flex items-center justify-center gap-2 p-4 bg-white border border-slate-200 rounded-2xl text-xs font-bold text-slate-600 hover:bg-slate-50 transition-all">
