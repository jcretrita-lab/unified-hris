            ...
            <>
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold text-slate-900">
                  {editor.id ? "Edit Component" : "Create Component"}
                </h3>
                ...
                <>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        className={`w-full border border-slate-200 p-3 rounded-xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none text-sm font-bold text-slate-900 transition-all bg-slate-50`}
                        value={editor.name || ""}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="flex flex-col justify-end gap-2">
                        <label className={`flex items-center gap-3 p-3 border border-slate-200 rounded-xl w-full cursor-pointer transition-colors bg-white h-[42px] hover:bg-slate-50`}>
                          <input type="checkbox" checked={editor.isTaxable} onChange={(e) => setEditor({ ...editor, isTaxable: e.target.checked })} className="w-4 h-4 text-emerald-600 rounded focus:ring-emerald-500 border-gray-300" />
                    ...
                    <button onClick={initiateSave} disabled={!editor.name} className="w-full bg-slate-900 hover:bg-slate-800 text-white py-3.5 rounded-xl font-bold mt-4 transition-all shadow-xl shadow-slate-200 active:scale-95 disabled:opacity-50">
                      {editor.id ? 'Save Changes' : 'Create Component'}
                    </button>
                  </div>
                </>
              )}
