...
export const MOCK_ADJUSTMENT_TYPES: AdjustmentType[] = [
  ...
  { id: 'adj-6', code: 'SALDIF', name: 'Salary Differential', category: 'Earning', isTaxable: true, description: 'Difference between full basic pay and SSS maternity benefit. Computable for 13th-month pay.' },
];
