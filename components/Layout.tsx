...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      <main className={`flex-1 min-w-0 min-h-screen relative transition-all duration-300 flex flex-col ${isSidebarOpen ? 'ml-64' : 'ml-20'}`}>
        {/* Universal Header */}
        ...
        <div className="p-10 w-full max-w-full mx-auto min-w-0 flex-1">
          <BreadcrumbProvider>
            <Breadcrumb />
            {children}
          </BreadcrumbProvider>
